...
namespace prx
{
    ...
    namespace sim
    {
        ...
        {
            state_memory = boost::assign::list_of(&_x)(&_y)(&_theta)(&_v)(&_w);
            control_memory = boost::assign::list_of(&_a)(&_sta);
        ...
        void second_order_car_learned_t::propagate(const double simulation_step)
        {
            ...
            std::vector<double> state_current = boost::assign::list_of(_x)(_y)(_theta)(_v)(_w)(_a)(_sta)(simulation_step);
