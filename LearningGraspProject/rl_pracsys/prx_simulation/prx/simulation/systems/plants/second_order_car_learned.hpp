...
#ifndef SECOND_ORDER_CAR_LEARNED_HPP
#define SECOND_ORDER_CAR_LEARNED_HPP
...
namespace prx
{
    namespace sim
    {
         ...
         * 
         */
        class second_order_car_learned_t : public plant_t
        {

          public:

            second_order_car_learned_t();

            virtual ~second_order_car_learned_t();
          ...
          protected:
            ...
            prx::learn::forward_car_model_t forward;
