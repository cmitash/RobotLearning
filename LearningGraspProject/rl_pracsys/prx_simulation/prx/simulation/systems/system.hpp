...
namespace prx
{
    ...
    namespace sim
    {
        ...
        /**
         * The base class used for individual rigid body information in the collision checker.
         * As an efficiency gain, pointers to the this info class will be kept in plants (where)
         * real geometry lies.
         * 
         * @brief Info that contains the rigid body information for collision checking.
         * 
         * @authors Zakary Littlefield
         */
        class collision_checker_info_t
        {
            public:
                  virtual void update_matrices(const util::config_t & config) = 0;
        ...
        class system_t
        {
          ...
          public:
            ...
            virtual void link_collision_info(collision_checker_t* collision_checker) = 0;
            virtual void update_collision_info() = 0;
        ...
        namespace simulation
        {
            ...
            extern ros::Time simulation_time;
