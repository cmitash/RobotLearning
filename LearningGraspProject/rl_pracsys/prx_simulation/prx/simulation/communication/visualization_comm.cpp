            ...
            void visualization_comm_t::send_geometries() 
            {
                if (app->is_visualizing()) 
                {
                    ...
                    foreach(std::string name, visualization_geom_map | boost::adaptors::map_keys) 
                    {
                        ...
                        {
                            // PRX_PRINT("Geom name: "<<visualization_geom_map[name][i].full_name, PRX_TEXT_MAGENTA);
                            // PRX_PRINT("Geom config: " << visualization_configs_map[name][i], PRX_TEXT_LIGHTGRAY);
                            // PRX_PRINT("Name: " << name, PRX_TEXT_LIGHTGRAY);
