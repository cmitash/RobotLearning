#include "planning/samplers/rrg_sampler.hpp"
...
PLUGINLIB_EXPORT_CLASS( prx::packages::apc::rrg_sampler_t, prx::plan::sampler_t)
...
namespace prx
{
    ...
    {        
        ...
        namespace apc
        {
            void rrg_sampler_t::init(const util::parameter_reader_t* reader, const util::parameter_reader_t* template_reader)
            {
            ...
            void rrg_sampler_t::sample(const space_t* space, space_point_t* point)
            {
            ...
            void rrg_sampler_t::sample_near(const space_t* space, space_point_t* near_point, std::vector<bounds_t*>& in_bounds, space_point_t* point)
            {
                bool suc = false;
                std::string old_context = manip_model->get_current_context();
                config_t config;
            ...
            void rrg_sampler_t::link_world_model(plan::world_model_t* wm)
            {
