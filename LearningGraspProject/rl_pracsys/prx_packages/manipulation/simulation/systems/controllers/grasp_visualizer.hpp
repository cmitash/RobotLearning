        ...
        namespace manipulation
        {
            ...
            class grasp_visualizer_t : public sim::controller_t
            {
              ...
              public:
                ...
                virtual void read_database_file();
              ...
              protected:
                ...
                util::tf_listener_t finger_1;
                util::tf_listener_t finger_2;
                util::tf_listener_t finger_3;
                
                util::config_t finger_1_config;
                util::config_t finger_2_config;
                util::config_t finger_3_config;

                std::vector<std::vector<double> > object_poses;
                std::string grasp_path, start_link, end_link;
