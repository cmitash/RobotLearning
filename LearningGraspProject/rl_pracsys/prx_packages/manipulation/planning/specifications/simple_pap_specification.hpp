...
#ifndef PRX_SIMPLE_PAP_SPECIFICATION_HPP
#define PRX_SIMPLE_PAP_SPECIFICATION_HPP
...
namespace prx
{
    ...
    namespace packages
    {
        ...
        {
            /**
             * @anchor simple_pap_specification_t
             *
             ...
             */
            class simple_pap_specification_t : public plan::specification_t
            {

              public:
                simple_pap_specification_t();
                virtual ~simple_pap_specification_t();
