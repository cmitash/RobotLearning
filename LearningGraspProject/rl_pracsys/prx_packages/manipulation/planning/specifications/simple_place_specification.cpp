...
PLUGINLIB_EXPORT_CLASS(prx::packages::manipulation::simple_pap_specification_t, prx::plan::specification_t)
...
namespace prx
{
    ...
    namespace packages
    {
        ...
        {
            simple_pap_specification_t::simple_pap_specification_t()
            {
            }
            ...
            void simple_pap_specification_t::init(const parameter_reader_t* reader, const parameter_reader_t* template_reader)
            {
