...
bool graph_proximity_t::does_node_exist( proximity_node_t* query_node, proximity_node_t** node_list, int list_size )
{
    bool exists = false;
...
int graph_proximity_t::sampling_function()
{
    if( nr_nodes < 1000 )
	return nr_nodes/5 + 1;
    else
...
int graph_proximity_t::percolation_threshold()
{
    int k;
