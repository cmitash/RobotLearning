 ...
 * 
 * Proximity node for the graph-based distance metric. It wraps around the PRACSYS node, considering it as only storage.
 * 
...
class graph_proximity_t
{
    ...
    protected:
        ...
        hash_t<proximity_node_t*,bool> added_nodes;
